  ...
  return (
    <PageShell>
      ...
      <section className="container mx-auto px-4 py-8">
        ...
        >
          <div className="glass-petrol rounded-[2.5rem] p-8 md:p-12 text-center relative overflow-hidden">
      ...
      {/* Il nostro core — Finanziamenti agevolati (con rendicontazione) */}
      <section className="container mx-auto px-4 py-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="grid gap-10 md:grid-cols-[1fr_1.1fr] md:items-center">
            <div>
              <span className="text-xs uppercase tracking-[0.3em] text-petrol dark:text-teal-300">
                Il nostro core
              </span>
              ...
              <p className="mt-5 text-muted-foreground leading-relaxed">
                ...
                accompagniamo l'azienda in ogni fase: dalla stesura della domanda alla gestione
                del finanziamento, fino alla rendicontazione finale.
              </p>
            </div>

            <div className="grid gap-8 sm:grid-cols-3">
              {[
                { icon: FileSearch, t: "Analisi", d: "Individuiamo il bando più coerente con il progetto." },
                { icon: Banknote, t: "Domanda & gestione", d: "Stesura della domanda e gestione del finanziamento." },
                { icon: ClipboardCheck, t: "Rendicontazione", d: "Vi accompagniamo fino alla rendicontazione finale." },
              ].map((s) => (
                <div key={s.t}>
                  <s.icon className="mb-3 text-petrol dark:text-teal-300" size={24} />
                  <h3 className="font-display text-sm font-semibold leading-tight">{s.t}</h3>
      ...
      <section className="container mx-auto px-4 py-14">
        ...
        >
          ...
          <p className="mt-4 text-muted-foreground">
            Dalla ricerca applicata all'accesso ai finanziamenti: un unico partner per l'intero
            percorso.
          </p>
          <Link
            to="/contatti"
